...
9/24/26: Hostinger informed that the "website in question is no longer accessble", the domain is still resolving so it was not suspended, and the site is still completely accessible on port 7443. Replied to Hostinger pushing for domain suspension.